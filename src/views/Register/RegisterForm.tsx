...
import { Box, Grid, Typography, Theme, Checkbox, IconButton, InputAdornment, Button } from '@material-ui/core'
        ...
        <Box>
          <form onSubmit={handleSubmit(onSubmit)} className={classes.form}>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
              <Checkbox name="checkedA" color="primary" style={{ paddingLeft: '0' }} />
